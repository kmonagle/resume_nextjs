...
// On Render's free tier a sleeping backend answers Render's 502 page or takes up to a minute. The
 ...
 * passed, whichever comes first. The original promise is NOT cancelled; it simply keeps running
 * in the background.
 */
